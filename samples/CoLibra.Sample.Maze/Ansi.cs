...
internal static class Ansi
{
    ...
    public const string Clear = "\x1b[2J\x1b[H"; // clear screen + home
    public const string HideCursor = "\x1b[?25l";
    public const string ShowCursor = "\x1b[?25h";

    public static string Fg(byte r, byte g, byte b) => $"\x1b[38;2;{r};{g};{b}m";

    public static string Bg(byte r, byte g, byte b) => $"\x1b[48;2;{r};{g};{b}m";

    /// <summary>HSV (h in [0,360), s and v in [0,1]) to RGB — the basis of the maze's gradients.</summary>
    ...
    /// <summary>A stable vivid color for a player, hashed from its name.</summary>
