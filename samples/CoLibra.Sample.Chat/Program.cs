...
internal static class Program
{
    private static async Task Main(string[] args)
    {
        ...
        builder.Services.AddSingleton(new ChatSettings(name, builder.Configuration.GetValue<string?>("Say", null)));
...
internal sealed record ChatSettings(string Name, string? AutoSay);
